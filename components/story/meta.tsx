...
export default function StoryMeta({ data, time = false, articles = false }: { data: any, time?: boolean, articles?: boolean }) {
  return (
    <div className='flex items-center text-gray-600 dark:text-gray-300 mt-2 text-sm font-bold'>
      ...
      <span className='ml-auto flex-row flex items-center'>
        ...
        {data.meta.sources && data.meta.sources > 0 &&
        ...
        {data.meta.social && data.meta.social > 0 &&
