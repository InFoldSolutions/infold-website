    ...
    <div className='pl-3'>
      <ul>
        {data.map((item: Item, index: number) => (
          <li className='pb-8 pl-5 pr-2 md:px-10 last:pb-4 pt-1 border-gray-200 border-l-2 border-b-2 border-dashed dark:border-neutral-600 last:border-b-0 cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800 dark:hover:bg-opacity-40 hover:bg-opacity-30'
