    ...
    <div className='pl-2'>
      <ul>
        {data.map((item: Item, index: number) => (
          <li className='py-10 pb-8 pl-5 pr-2 md:px-10 border-white border-l-2 border-b-2 border-dashed dark:border-neutral-600 last:border-b-0 last:pb-4 first:pt-4' key={index}>
            <TimeAgo
