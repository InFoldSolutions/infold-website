      ...
      {login &&
        <div className="flex flex-col items-center justify-center mt-1">
          ...
          <div className="flex w-full items-stretch">
            ...
            <Tooltip message={`Login with Google`} top={12} right={3} padding={1} minWidth={129}>
              <span className='shrink-0 h-10 w-10 p-2 bg-gray-300 dark:bg-black ml-1 flex items-center justify-center cursor-pointer rounded' onClick={() => signInWithGoogle()}>
            ...
            <Tooltip message={`Login with X`} top={12} right={3} padding={1} minWidth={96}>
              <span className='shrink-0 h-10 w-10 p-2 bg-gray-300 dark:bg-black ml-1 flex items-center justify-center cursor-pointer rounded' onClick={() => signInWithTwitter()}>
