  ...
  return (
    <div className="mt-2 ml-1">
      {Array(number).fill(0).map((el, index) => (
        <div key={index} className="py-4 border-gray-200 border-b-2 border-dashed dark:border-gray-800 dark:border-opacity-80 rounded last:border-b-0 animate-pulse w-[96%]">
