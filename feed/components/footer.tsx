...
export default function Footer() {
  ...
  return (
    <footer className="flex -ml-4 py-3 pb-4 border-t-2 border-gray-200 border-dashed dark:border-gray-800 dark:border-opacity-80 bg-gray-300 dark:bg-black fixed lg:w-full right-4 md:right-8 lg:right-auto left-4 md:left-8 lg:left-auto -bottom-px max-w-[1196px] z-40">
