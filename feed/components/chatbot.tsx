  ...
  return (
    <div className="flex flex-col w-full items-center mt-2">
      ...
      <div className='flex items-stretch w-full items-center mt-4'>
        ...
        <Tooltip message={"Foldy is powered by Llama 2 and fine-tuned for each topic to provide you with the most relevant information"} top={20} right={6} minWidth={220} padding={2}>
