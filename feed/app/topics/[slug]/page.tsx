    ...
    <Container>
      <div className='flex items-start mt-5'>
        ...
        <div className='sticky top-[100px] h-auto hidden lg:flex flex-col'>
          <div className='h-auto w-[270px] pt-4 px-4 bg-gray-200 dark:bg-gray-600 dark:bg-opacity-20 hidden lg:flex flex-col mb-4'>
            <h3 className='text-2xl font-bold'>Sentiment</h3>
            <Sentiment />
          </div>

          <div className='h-auto w-[270px] p-6 bg-gray-200 dark:bg-gray-600 dark:bg-opacity-20 hidden lg:flex flex-col'>
            <ul>
